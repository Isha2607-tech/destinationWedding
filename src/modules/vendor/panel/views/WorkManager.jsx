      ...
      <div className="space-y-8 animate-wedding-fade-up">
        ...
        <div className="bg-white rounded-[2.5rem] border border-[#F3E9E2] p-6 md:p-8 shadow-sm">
           ...
           <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              ...
              <button className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-[#B06A6C] text-white font-bold text-sm shadow-xl shadow-[#B06A6C]/20 hover:scale-105 transition-all">
           ...
           {activeTab === "Portfolio" && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                   ...
                   <div key={i} className="group relative aspect-[4/5] rounded-[2rem] overflow-hidden bg-slate-50 border border-[#F3E9E2] shadow-sm">
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center gap-3">
                         <div className="flex gap-2">
                           <button className="w-10 h-10 rounded-xl bg-white text-[#B06A6C] flex items-center justify-center hover:bg-[#B06A6C] hover:text-white transition-all">
                 ...
                 <div className="aspect-[4/5] rounded-[2rem] border-2 border-dashed border-[#F3E9E2] bg-[#F3E9E2]/10 flex flex-col items-center justify-center gap-3 cursor-pointer group hover:bg-[#F3E9E2]/20 transition-all">
                    <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-[#B06A6C] shadow-sm group-hover:scale-110 transition-transform">
           ...
           {activeTab === "Albums" && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {initialAlbums.map((album) => (
                   <div key={album.id} className="group relative bg-[#F3E9E2]/20 rounded-[2rem] p-4 border border-transparent hover:border-[#B06A6C]/20 hover:bg-white hover:shadow-xl transition-all duration-300">
                      <div className="aspect-[16/10] rounded-2xl overflow-hidden mb-4 relative">
                        ...
                        <div className="absolute top-3 right-3">
                           <button className="w-8 h-8 rounded-lg bg-white/20 backdrop-blur text-white flex items-center justify-center hover:bg-white hover:text-[#B06A6C] transition-all">
                      ...
                      <div className="flex items-center justify-between px-1">
                        <div className="space-y-0.5">
                           <h4 className="text-base font-black text-[#4A3730] " >{album.title}</h4>
                           <p className="text-[11px] font-bold text-[#8E7E77] uppercase tracking-widest leading-none">{album.count} Photos</p>
                        </div>
                        <button className="w-10 h-10 rounded-xl bg-[#B06A6C]/10 text-[#B06A6C] flex items-center justify-center group-hover:bg-[#B06A6C] group-hover:text-white transition-all shadow-inner">
                 ...
                 <div className="rounded-[2rem] border-2 border-dashed border-[#F3E9E2] bg-[#F3E9E2]/10 h-[260px] flex flex-col items-center justify-center gap-4 cursor-pointer group hover:bg-[#F3E9E2]/20 transition-all">
                    <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center text-[#B06A6C] shadow-sm group-hover:scale-110 transition-transform">
                      <Plus className="w-8 h-8" />
                    </div>
                    <div className="text-center">
                      <p className="text-sm font-black text-[#4A3730] " >New Album</p>
           ...
           {activeTab === "Videos" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   ...
                   <div key={video.id} className="group relative bg-white rounded-[2rem] overflow-hidden border border-[#F3E9E2] hover:shadow-xl transition-all duration-500">
                      <div className="aspect-video relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                           <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center text-white group-hover:scale-110 group-hover:bg-[#B06A6C]/80 transition-all duration-300">
                      ...
                      <div className="p-6 flex items-center justify-between">
                         <div className="space-y-1">
                            <h4 className="text-lg font-black text-[#4A3730] " >{video.title}</h4>
                            <div className="flex items-center gap-1.5 text-[10px] font-black text-[#B06A6C] uppercase tracking-widest">
                               <Video className="w-3 h-3" />
                               Wedding Highlight
                            </div>
                         </div>
                         <button className="px-4 py-2 rounded-xl bg-[#F3E9E2] text-slate-600 text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 hover:bg-[#B06A6C] hover:text-white transition-all group/link">
                 ...
                 <div className="bg-[#FFFDFB] rounded-[2rem] border-2 border-dashed border-[#F3E9E2] p-8 flex flex-col items-center justify-center gap-4 group">
                    <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-[#B06A6C] shadow-sm">
                      <Plus className="w-6 h-6" />
                    </div>
                    <div className="text-center space-y-2">
                       <p className="text-sm font-black text-[#4A3730] " >Add YouTube Link</p>
                       <p className="text-[11px] text-[#8E7E77] font-medium leading-relaxed max-w-[200px]">
                         Video highlights improve lead conversion by <span className="text-[#B06A6C] font-black">40%</span>.
                       </p>
                    </div>
                 </div>
              </div>
