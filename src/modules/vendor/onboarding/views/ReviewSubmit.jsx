    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 pb-16 md:pb-24">
        <div className="p-5 md:p-8 rounded-2xl bg-card border border-border wedding-shadow animate-wedding-fade-up space-y-5">
          {/* Basic Info */}
          <SectionCard icon={User} title="Basic Info" editPath="/vendor/onboarding/step-1">
          ...
          {/* Portfolio */}
          <SectionCard icon={Camera} title="Portfolio" editPath="/vendor/onboarding/step-2">
            {portfolio.length > 0 ? (
          ...
          {/* Services */}
          <SectionCard icon={Briefcase} title="Services" editPath="/vendor/onboarding/step-3">
          ...
          {/* Pricing */}
          <SectionCard icon={IndianRupee} title="Pricing" editPath="/vendor/onboarding/step-4">
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
